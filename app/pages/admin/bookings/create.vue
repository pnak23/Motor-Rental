      ...
      <form @submit.prevent="submit">
        ...
        <div class="d-flex gap-2">
          <button type="submit" class="btn btn-amber" :disabled="submitting">
            <span v-if="submitting" class="spinner-border spinner-border-sm me-2" />Create Booking
          </button>
          <NuxtLink to="/admin/bookings" class="btn btn-outline-charcoal">Cancel</NuxtLink>
        </div>
      </form>
    </div>
  </div>
...
definePageMeta({ layout: 'admin', middleware: 'admin-auth', title: 'New Booking' })
